...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if ([self.progressDelegate respondsToSelector:@selector(webViewRequestUrlString:)]) {
        [self.progressDelegate webViewRequestUrlString:request.URL.absoluteString];
    }
...
{
    /** andrew zhang add 解决webview引起的内存泄漏 */
